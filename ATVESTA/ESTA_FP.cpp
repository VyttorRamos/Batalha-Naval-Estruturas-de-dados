...
// Implementacao: Jogo da Velha, Batalha Naval, Fila, Pilha, Ponteiros,
//                Lista Encadeada e Grafos
// =============================================================================
...
struct jg_velha{
    ...
    // Construtor: inicializa as variaveis necessarias.
    jg_velha() {
        jogador = 'X'; // comeca com jogador X
        coluna = -1;
        linha = -1;
    }

    // Chama a estrutura do jogo da velha.
    void jogovelhachama(){
    ...
    // Le a linha e coluna em que o jogador deseja posicionar o X ou O.
    void joga(){
        ...
        // Verifica se ha ganhador atraves da funcao verifica().
        if(verifica() == 1){
                system("cls");
                jogovelhachama();
                cout << "===============================" << endl;
        ...
        // Verifica se ha empate atraves da funcao verifica().
        if(verifica() == -3){
                system("cls");
                jogovelhachama();
                cout << "===============================" << endl;
    ...
    // Verifica todas as possibilidades de vitoria e empate.
   int verifica(){
...
struct BNaval{
    ...
    BNaval() {
        // Inicializando as matrizes com espacos em branco
        for(int i = 0; i < 10; ++i) {
            for(int j = 0; j < 10; ++j) {
                game[i][j] = " ";
                game2[i][j] = " ";
...
void inserirFim(NoLista*& l) {
    ...
    if (l == nullptr) {
        l = novo; // Lista vazia, o novo no e o primeiro
    } else {
        NoLista* p = l;
...
bool removerFim(NoLista*& apontadorInicioLista) {
    ...
    if (apontadorInicioLista == nullptr) {
        ...
        return true; // Lista com apenas um no
    } else {
...
void ordenarCrescente(NoLista*& l) {
    if (l == nullptr || l->prox == nullptr) return; // Lista vazia ou com um unico elementolemento
  ...
  public:
     ...
     void GrafoTes::inserirArestas(){
        ...
        if(linha <= MaxVertices && coluna <= MaxVertices){
            ...
            cout << "Vertices nao encontrados, insira novamente" << endl;
        }
    ...
    //validacao se inserir denovo no mesmo indice
     ...
     void GrafoTes::apresentar(){
             ...
             cout << "           Tabela            " << endl;
             cout <<"-------------------------------" << endl;
             cout << "  Nos    |    Segmentos   |  Total Vertices" << endl;
             for(int i = 0;i < MaxVertices;++i){
                cout << "   " << linhaVertice[i] << "             ";
                for(int j = 0; j < MaxVertices; ++j){
